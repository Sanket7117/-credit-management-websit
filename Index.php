...
<h1 style="    text-align: center;
 ...
 <div class="card-deck">
  ...
  <div class="card">
    ...
    <a class="btn btn-primary" href="userpage.php" role="button" style="width:150px; float: middle;background-color:rgba(0, 123, 255, 0.71);">Transfer</a>
  </div>
    
  </div>
  <div class="card">
    <h1 style="background-color: #d39e00;height: 150px;width: auto;text-align:center">Transaction Table</h1>
    <div class="card-body" style="height: 100px;width: auto; background-color: aliceblue;">
  ...
  <footer style="margin-top: 50px;">
    <div class="wrapper">
        <div id="footer-info" style="    margin-left: 25px">
            <p>Copyright 2014 Credit Management. All rights reserved.</p>
